...
import org.lovepeaceharmony.android.app.databinding.ActivityLoginBinding
...
import org.lovepeaceharmony.android.app.viewmodel.LoginViewModel
...
class LoginActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        observeNetworkEvents(this)
        initView()
        lifecycleScope.launch {
            lifecycle.repeatOnLifecycle(Lifecycle.State.CREATED) {
                viewModel.firstEntry.collect { firstEntry ->
                    if (firstEntry) TapTarget.forView(
                        binding.header.ivAppName,
                        resources.getString(R.string.login_tooltip_title),
                        resources.getString(R.string.tap_anywhere_to_continue)
                    ).init(this@LoginActivity, R.color.tool_tip_color1) {}
                }
            }
        }
    }
    ...
    private fun signInWithGoogle() {
        if (networkConnected) {
            ...
            getActivityLauncher(this).launch(
